...
from authapis.serializers import ForgotPasswordRequestSerializer, SuccessResponseSerializer
from rest_framework.generics import GenericAPIView
from rest_framework.response import Response
from authapis.services.forgot_password_service import ForgotPasswordService
...
class ForgotPasswordView(GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            serializer.is_valid()
            response = ForgotPasswordService(**serializer.data).get_response()
